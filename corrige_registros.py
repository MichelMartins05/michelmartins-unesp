...
for planilha in xls.sheet_names:
    ...
    for index, coluna in df.iterrows():
        ...
        id_defeituosos = os.path.join(diretorio_saida, planilha, coluna['ID (Defeituosos)'] + '.nii.gz')
        id_saudaveis = os.path.join(diretorio_saida, planilha, coluna['ID (Saudáveis)'] + '.nii.gz')
